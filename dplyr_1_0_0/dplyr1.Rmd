...
## Short history of **{dplyr}**

**{dplyr}** version 1.0 is the result of 15 years of work by Hadley Wickham

- 05/08/2005: **{reshape}** version 0.4, *"Flexibly reshape data"*

- 08/10/2008: **{plyr}** version 0.1.1, *"Tools for splitting, applying and combining data"*

<!-- - 2008 Hadley finishes in PhD *"Practical tools for exploring data and models"*

- 2013 Hadley starts working at RStudio -->

- 29/01/2014: **{dplyr}** version 0.1.1, *"dplyr: a grammar of data manipulation"*

- 29/05/2020: **{dplyr}** version 1.0.0
...
## There are a new interesting vignettes

```{r, eval = FALSE}
browseVignettes("dplyr")
```

<p><center>![](./img/vignettes.png)</center></p>

<br></br>
Note: there is an interesting new vignette "From base R to dplyr" for those who only know base R


# **{dplyr}** in its ecosystem
...
Several dependencies to the **latest** versions of some **tidyverse** packages: 
```
magrittr (>= 1.5)
tidyselect (>= 1.1.0)
lifecycle (>= 0.2.0)
...
4 of these packages have been updated very recently, in view of the new release of **{dplyr}**

<br></br>

Note: I won't talk about **{magrittr}** which has not been updated in a while and which simply provides the pipe (`%>%`) to **{dplyr}**
